                                    ...
                                    <div class="row align-items-center mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Price Quad" name="price_quad" value="{{ old('price_quad') }}" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Price Triple" name="price_triple" value="{{ old('price_triple') }}" required>
                                                    <span class="input-group-text">{{ gs()->cur_sym }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Price Double" name="price_double" value="{{ old('price_double') }}" required>
                                                    <span class="input-group-text">{{ gs()->cur_sym }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="Base Price" name="price" value="{{ old('price') }}" required>
                                                    <span class="input-group-text">{{ gs()->cur_sym }}</span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 mt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="number" step="any" name="discount" class="form-control" placeholder="@lang('Discount')">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="airline_name" class="form-control" placeholder="e.g. Saudia Airlines" value="{{ old('airline_name') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="departure_city" class="form-control" placeholder="e.g. Jakarta" value="{{ old('departure_city') }}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="hotel_makkah" class="form-control" placeholder="Makkah Hotel Name" value="{{ old('hotel_makkah') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="mb-2 form--label">@lang('Makkah Rating')</label>
                                                <select name="hotel_makkah_rating" class="form-control">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="hotel_madinah" class="form-control" placeholder="Madinah Hotel Name" value="{{ old('hotel_madinah') }}">
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                <label class="mb-2 form--label">@lang('Madinah Rating')</label>
                                                <select name="hotel_madinah_rating" class="form-control">
                                                    <option value="5">5 Star</option>
                                                    <option value="4">4 Star</option>
                                                    <option value="3">3 Star</option>
                                                </select>
